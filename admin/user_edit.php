                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask name="tanggal_lahir" value="<?php echo date('Y-m-d', strtotime($data['tanggal_lahir']));?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
